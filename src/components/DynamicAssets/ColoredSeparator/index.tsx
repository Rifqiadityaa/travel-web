...
const ColoredSeparator: FC<SVGProps<SVGSVGElement> & { isWhite?: boolean }> = (
  ...
  <svg
    width={1096}
    height={97}
    fill={props.isWhite ? "#FFFFFF" : "none"}
  ...
  >
    ...
    <path
      ...
      fill={props.isWhite ? "#FFFFFF" : "#B39859"}
    />
    <path
      d="m549.113 33.12 12.59 14.14h9.972l-22.562-25.34v11.2Z"
      fill={props.isWhite ? "#FFFFFF" : "#EDD395"}
    />
    <path
    ...
    <path
      ...
      stroke={props.isWhite ? "#FFFFFF" : "#D6B66B"}
      strokeWidth={3.9}
      strokeMiterlimit={10}
    />
  </svg>
